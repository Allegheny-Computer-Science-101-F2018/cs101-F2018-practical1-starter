...
# cs101-F2018-practical1-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 1 in Computer Science 101.
...
- practicalone/Swap.java:
  - Contains at least three multiple-line comments in the JavaDoc standard
  - Runs correctly without crashing or producing an error
  - Produces exactly six lines of output in the terminal
  - Produces output that contains exactly one of the fragment `Values before
    the swap`
  - Produces output that contains exactly one of the fragment `Values after
    the swap`
  - Produces output that contains exactly two of the fragment `10`
  - Produces output that contains exactly two of the fragment `20`
  - Passes all of the test cases defined in the `TestCreditCard.java` file.

- practicalone/TestSwap.java:
  - Contains at least three multiple-line comments in the JavaDoc standard
  - Contains at least three of the `@Test` fragments starting a test case
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2018/cs101-F2018-practical1-starter.git
```
...
you can go to the [Computer Science 101 Practical 1
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-practical1-starter)
